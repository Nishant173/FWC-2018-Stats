...
for i in range(0, 32):
    ...
    plt.savefig("%s.png" % rus.Team.unique()[0]) # indexing by name of team, using strings
# break the loop.
...
for i in range(0, 32):
    ...
    #plt.savefig("004_supposedly.png")
    #plt.savefig("%i.png" % i) # integer indexing
    plt.savefig("%s - Accuracy.png" % rus.Team.unique()[0]) # indexing by name of team, using strings
# break the loop.
